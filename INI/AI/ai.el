...
(defhydra hydra-ai-model-menu (:color blue)
  ...
  ("gt" (load "~/Dropbox/backup/models/gemeni1-5.el") "GemeniT")
  ;; (find-file-other-frame "~/Dropbox/backup/models/fast-gemeni.el")
  ("gg" (load "~/Dropbox/backup/models/fast-gemeni.el") "FastGemeni")
  ...
  ("mm" (load "~/Dropbox/backup/models/mixtral.el") "Mistral-def")
  ("ml" (progn (load "~/Dropbox/backup/models/mixtral.el")
               (setq gptel-model 'mistral-large-latest)) "Mistral-lrg")
  ("mM" (progn (load "~/Dropbox/backup/models/mixtral.el")
               (setq gptel-model 'mistral-large-latest)) "mistral-med")
  ("mc" (progn (load "~/Dropbox/backup/models/mixtral.el")
               (setq gptel-model 'mistral-large-latest)) "mistral-cod")
  ("mv" (progn (load "~/Dropbox/backup/models/mixtral.el")
               (setq gptel-model 'mistral-large-latest)) "mistral-vib")
  ;; (find-file-other-frame "~/Dropbox/backup/models/Qwen.el")
  ("ww" (load "~/Dropbox/backup/models/Qwen.el") "Qwen-def")
  ("wC" (progn (load "~/Dropbox/backup/models/Qwen.el")
               (setq gptel-model 'qwen-7b-chat)) "Qwen-cht")
  ("wm" (progn (load "~/Dropbox/backup/models/Qwen.el")
               (setq gptel-model 'qwen3-max)) "Qwen-max")
  ("wc" (progn (load "~/Dropbox/backup/models/Qwen.el")
               (setq gptel-model 'qwen3-coder-plus))"Qwen-cod")
  ;; (find-file-other-frame "~/Dropbox/backup/models/llama70v.el")
  ("ll" (load "~/Dropbox/backup/models/llama70v.el") "llama70v")
  ;; (find-file-other-frame "~/Dropbox/backup/models/grog-mixtral.el")
  ("GM" (load "~/Dropbox/backup/models/grog-mixtral.el") "G-mixtral")
  ;; (find-file-other-frame "~/Dropbox/backup/models/grog-llama70v.el")
  ("GL" (load "~/Dropbox/backup/models/grog-llama70v.el") "Q-llama70v")
  ("q" nil))
...
(defhydra hydra-ai-role-menu (:color blue)
  ...
  ("s" (load "~/Dropbox/Office/Games/aidungeon/els/ai-synod.el") "Synode AI")
  ("l" (load "~/Dropbox/Office/Games/aidungeon/els/leeloo-chat.el") "LeeLoo")
  ("w" (load "~/Dropbox/Office/Games/aidungeon/els/Washu-chat.el") "Washu")
...
(defhydra hydra-ai-chat-menu (:color blue)
  ...
  ("w" (progn
          (load "~/Dropbox/Office/Games/aidungeon/els/Washu-chat.el")
          (find-file-other-frame "~/Dropbox/Office/Games/aidungeon/els/Washu-chat.el")
         ) "Washu")
  ("l" (progn
