...
(define-key evil-normal-state-map (kbd "M-a M-f M-n") 'evil-prev-flyspell-error)
(define-key evil-normal-state-map (kbd "M-a M-f M-p") 'evil-next-flyspell-error)
(define-key evil-normal-state-map (kbd "M-a M-f <SPC>") 'lit-menu/body)
