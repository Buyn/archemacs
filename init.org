...
(add-to-list 'load-path (expand-file-name "ELs/text-to-speech/read-aloud" user-emacs-directory))
(require 'read-aloud)
#+begin_src elisp
(use-package read-aloud
  :defer t
  ;; :load-path "ELs/text-to-speech/read-aloud/"
  :load-path (expand-file-name "ELs/text-to-speech/read-aloud" user-emacs-directory)
  )
#+end_src
